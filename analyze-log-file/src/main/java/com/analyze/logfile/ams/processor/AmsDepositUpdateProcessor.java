 ...
 */
public class AmsDepositUpdateProcessor extends AbstractAmsProcessor {
    ...
    public static void main(String[] args) {
        AbstractAmsProcessor AmsDepositUpdateProcessor = new AmsDepositUpdateProcessor("D:/Nextop/20 story/079 TRSPT-9700 Summary request traffic of AmsApi/summary-log/ams-api-controller.log.2016-09-01");
