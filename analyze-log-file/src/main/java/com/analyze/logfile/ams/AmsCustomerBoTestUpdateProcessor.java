...
public class AmsCustomerBoTestUpdateProcessor extends AbstractAmsPorcessor {
    ...
    public static void main(String[] args) {
        AmsCustomerBoTestUpdateProcessor amsCustomerAgreementNewsProcessor = new AmsCustomerBoTestUpdateProcessor("D:/Nextop/20 story/079 TRSPT-9700 Summary request traffic of AmsApi/summary-log/ams-api-controller.log.2016-09-01");
